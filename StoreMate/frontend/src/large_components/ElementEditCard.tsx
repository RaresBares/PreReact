...
async function apiUpdateMeta(barcode: string, body: Record<string, any>) {
    const u = new URL(`${API_BASE}/api/storemate/inventory/update_metadata/${encodeURIComponent(barcode)}`, window.location.origin)
...
async function apiDeleteItem(barcode: string) {
    const u = new URL(`${API_BASE}/api/storemate/inventory/delete_item/${encodeURIComponent(barcode)}`, window.location.origin)
...
async function apiGetItemInfo(barcode: string) {
    const u = new URL(`${API_BASE}/api/storemate/inventory/get_item_info/${encodeURIComponent(barcode)}`, window.location.origin)
